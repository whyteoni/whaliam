...
I hope to create dedicated pages for the most notable of entries on this list, but for now just need a place to quickly jot them all down.

## Books

While I tend to prefer nonfiction titles for this genre, there are some notable works of fiction that I feel are good reads for interested parties to be familiar with as well.
...
* [Cryptonomicon](/recommendations/cryptonomicon-1999) by Neal Stephenson, 1999. A head of its time, this book envisions what we would now call _Stable Coin_, and looks at the practical application of cryptography following two intertwined stories spanning WW2 and the 1990s. One of my all time favorite books, and a must read.

## Movies

* [Hackers](/recommendations/hackers-1995) staring Jonny Lee Miller, Angelina Jolie, and Fisher Stevens, 1995. A fictional tale of a young man transplanted from Seattle to New York who finds friends in the local hacker scene, while trying to escape his past. While the story is fictional, everything else is based of the lives, actions, and prosecutions of New York City hackers in 1990s.
...
* [Dark Reading](https://www.darkreading.com/) 20 years of reporting on cybersecurity.

* [KrebsOnSecurity](https://krebsonsecurity.com/) A blog from one of the top journalists in the field. Find out about his surprising origin story in [Spam Nation](/recommendations/spam-nation-2014).
